...
<html lang="en">
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/15.jpg);" data-stellar-background-ratio="0.5">
	      	...
	      	<div class="overlay"></div>
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
			            ...
			            <p class="mb-4">“Great nails don’t happen by chance. They happen by appointment.”</p>
